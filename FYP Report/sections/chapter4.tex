...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.2\linewidth, height=0.15\linewidth]{Images/blender.png}
...
This tool is utilized for virtual space locomotion, object interactions, Unity3D UI elements, body physics, and 2D and 3D controls like buttons, levers, doors, and drawers.
\begin{figure}[h]
	\centering
